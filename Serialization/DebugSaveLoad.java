    ...
    public static void main(String[] args) {
        ...
        try {
           // File your_file_name = File.createTempFile("", null);
            ...
            System.out.println(somePerson.name + Arrays.asList(somePerson.assets));
            System.out.println(ivanov.name + Arrays.asList(ivanov.assets));
            inputStream.close();
